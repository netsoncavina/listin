...
class ListinService {
  ...
  Future<List<Listin>> getListins() async {
    ...
    QuerySnapshot<Map<String, dynamic>> listinsSnapshot = await firestore.collection(uid).get();
  ...
  Future<void> duplicateListin({
    ...
    DocumentSnapshot<Map<String, dynamic>> oldListinSnapshot = await firestore.collection(uid).doc(listinId).get();
    ...
    QuerySnapshot<Map<String, dynamic>> oldProductsSnapshot = await firestore.collection(uid).doc(listinId).collection("produtos").get();
