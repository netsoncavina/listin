...
class ProductService {
  ...
  togglePurchased({required Product produto, required String listinId}) async {
    ...
    await firestore.collection(uid).doc(listinId).collection("produtos").doc(produto.id).update({"isComprado": produto.isPurchased});
  }
  ...
  Future<void> removeProduct({required Product produto, required String listinId}) async {
